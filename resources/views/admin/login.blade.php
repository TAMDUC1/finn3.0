...
<body>
<div id="loginbox">
    <form id="loginform" class="form-vertical" method="post" action="{{route('adminLogin')}}">
        {{csrf_field()}}
        ...
        <div class="form-actions">
            ...
            <span class="pull-right"><button type="submit" class="btn btn-success">Login1</button></span>
        </div>
    </form>
