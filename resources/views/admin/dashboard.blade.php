...
@section('main')
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Admin</a></div>
        </div>
        <!--End-breadcrumbs-->
        ...
        <div class="container-fluid">
            <div class="quick-actions_homepage">
                <ul class="quick-actions">
                    <li class="bg_lb"> <a href="{{route('admin.index')}}"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> My Dashboard </a> </li>
                            ...
                            <div class="chat-users panel-right2">
                                ...
                                <div class="panel-content nopadding">
                                    <ul class="contact-list">
                                        ...
                                        <li id="user-John" class="online new"><a href=""><img alt="" src="i{{asset('images/backend_images/demo/av3.jpg')}}" /> <span>John</span></a><span class="msg-count badge badge-info">3</span></li>
                ...
                <input type="text" name="msg-box" id="msg-box" />
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content tab-content">
                            ...
                            <div id="tab2" class="tab-pane"> <img src="{{asset('images/backend_images/demo/demo-image1.jpg')}}" alt="demo-image"/>
                                <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.</p>
                            </div>
